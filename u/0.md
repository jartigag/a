...
[read] cat\*, grep, head/tail, tee, (shuf, sort, uniq, wc)
...
[read] dir, {colors}, ls, pwd/basename, find, file. cksum, {md5,sha1,sha256}sum. strings, `xdd` (`echo "Hello World!" | od -t x1z`)
